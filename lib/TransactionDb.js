...
var encodedData = require('soop').load('bitcore-icash/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('bitcore-icash/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('bitcore-icash/lib/Address', {
